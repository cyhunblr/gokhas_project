...
#include <gokhas_perception/YoloResult.h>
#include <gokhas_perception/Detection2D.h>
...
private:
  ...
  message_filters::Subscriber<gokhas_perception::YoloResult> yolo_result_sub_;
...
public:
  ...
  void syncCallback(const sensor_msgs::CameraInfo::ConstPtr& camera_info_msg,
                    ...
                    const gokhas_perception::YoloResult::ConstPtr& yolo_result_msg);
  void projectCloud(const pcl::PointCloud<pcl::PointXYZ>::Ptr& cloud,
                    const gokhas_perception::YoloResultConstPtr& yolo_result_msg, const std_msgs::Header& header,
  ...
  void processPointsWithBbox(const pcl::PointCloud<pcl::PointXYZ>::Ptr& cloud,
                             const gokhas_perception::Detection2D& detection,
